...
import { protectPdf } from '@/lib/pdf/pdfTools';
import { Lock, Upload, Download, RefreshCw, ArrowLeft, CheckCircle2, FileText, KeyRound } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0b0f19] text-gray-100 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-black text-white">Protect PDF Document</h1>
          <p className="text-xs text-gray-400">Encrypt confidential PDF files with a secure password.</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-3xl p-6 space-y-6">
          {!file ? (
            <div className="border-2 border-dashed border-gray-800 hover:border-blue-500/60 rounded-2xl p-8 text-center space-y-3 bg-gray-950/50">
              ...
              <p className="text-sm font-bold text-gray-300">Upload PDF to Protect</p>
              <input type="file" accept="application/pdf" onChange={handleFileChange} id="pdf-protect-input" className="hidden" />
              <label
                htmlFor="pdf-protect-input"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 bg-gray-950 p-5 rounded-2xl border border-gray-800">
                <div>
                  <label className="block text-xs font-bold text-gray-400 mb-1 flex items-center gap-1.5">
                    <KeyRound className="w-3.5 h-3.5 text-blue-400" /> Set Document Password
                  </label>
                  <input
                    type="password"
                    value={password}
                    ...
                    className="w-full bg-gray-900 border border-gray-800 rounded-xl px-4 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
                  />
                </div>
                <div>
